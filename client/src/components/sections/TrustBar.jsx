...
export default function TrustBar() {
  ...
  return (
    <section className="bg-ink py-5 overflow-hidden border-y border-ink-line">
      <div className="relative flex">
        <div className="flex shrink-0 animate-marquee whitespace-nowrap motion-reduce:animate-none">
          {row.map((mark, i) => (
            <span key={i} className="mx-8 inline-flex items-center gap-3 text-white/70 text-sm font-semibold tracking-[0.18em] uppercase">
